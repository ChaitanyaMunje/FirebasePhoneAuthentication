...
public class AddCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //adding onclick listner to view data in new activity
        viewCoursesBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //opening a new activity on button click
                Intent i = new Intent(AddCoursesActivity.this,CourseDetails.class);
                startActivity(i);
            }
        });

        //adding on click listner for button
    ...
    private void addDataToFirestore(String courseName,String courseDescription,String courseDuration){
        ...
        //creating a collection refrence for our Firebase Firetore database.
        ...
        dbCourses.add(courses).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                //after the data addition is succesful
                //we are displaying a success toast message.
                Toast.makeText(AddCoursesActivity.this, "Your Course has been added to Firebase Firestore", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AddCoursesActivity.this, "Fail to add course \n"+e, Toast.LENGTH_SHORT).show();
            }
        });
